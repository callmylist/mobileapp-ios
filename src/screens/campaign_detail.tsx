...
> {
    ...
    componentDidMount() {
        ContactService.getContactInfo(
            this.props.navigation.state.params.campaign.contactlistId,
    ...
    startCampaign = () => {
        ...
        CampaignService.performCampaignAction(
    ...
    deleteCampaign = () => {
        ...
        CampaignService.deleteCampaign(this.state.campaign.id).subscribe(
            (response: any) => {
                if (response.success) {
