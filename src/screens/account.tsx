...
> {
        ...
        if (prevProps.loggedInContact !== this.props.loggedInContact) {
            this.setState({
                ...
                logoUrl:
                    ...
                    this.props.loggedInContact.customize.logoPath,
            });
        }
    }
    ...
    lockAccount = () => {
        ...
        CommonService.lockChildAccount(this.state.currentAccount.id).subscribe(
            (response: any) => {
                this.setState({
                    currentAccount: null,
                    loading: false,
    ...
    deleteAccount = () => {
        ...
        CommonService.deleteChildAccount(
        ...
        return (
            <SafeAreaView style={{flex: 1}}>
                ...
                <KeyboardAvoidingView
                    ...
                    <ScrollView>
                        <CmlText style={styles.campaignLabel}>Account</CmlText>
                                ...
                                <View
                                    ...
                                    <View
                                        ...
                                        <DateTimePickerModal
                                            ...
                                            mode="time"
                                            date={
                                                this.state.restrictions.endTime
                                            }
                                            onConfirm={(value: any) =>
                                                this.setState({
                                                    restrictions: {
                                ...
                                <View
                                    ...
                                    <View
                                        ...
                                        <RNPickerSelect
                                            ...
                                            value={
                                                this.state.restrictions.timeZone
                                            }
                                            onValueChange={(value) => {
                                                this.setState({
                                                    restrictions: {
                                    ...
                                    return (
                                        <TouchableOpacity>
                                            <View
                                                ...
                                                <CmlText
                                                    style={styles.itemContact}>
                                                    {item.item.email}
                                                </CmlText>

                                                <CmlText
                                                    style={styles.itemDial}>
                                                    ${item.item.fundsavailable}
                                                </CmlText>
                    ...
                    <Modal
                        ...
                        <View style={AppStyle.dialogContainer}>
                            <View>
                                ...
                                <CmlText style={AppStyle.dialogDescription}>
                                    Are you sure you want lock this child
                                    account?
                                </CmlText>
                                <View
                                    style={{
                    ...
                    <Modal
                        ...
                        <View style={AppStyle.dialogContainer}>
                            <View>
                                ...
                                <CmlText style={AppStyle.dialogDescription}>
                                    Are you sure you want delete this child
                                    account?
                                </CmlText>
                                <View
                                    style={{
