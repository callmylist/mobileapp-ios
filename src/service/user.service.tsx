...
export class UserService {
    ...
    static updatePassword(data: any) {
        return RestClient.patch(constants.apiUrl.updatePassword.replace("{userId}", store.getState().authReducer.loggedInContact.userId), data);
    }

    static deleteAccountLogo() {
        return RestClient.delete(constants.apiUrl.deleteAccountLogo.replace("{userId}", store.getState().authReducer.loggedInContact.userId));
    }
