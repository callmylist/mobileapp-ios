export default {
    ...
    apiUrl: {
        ...
        performCampaignAction:
            "/campaign/{campaignId}?action={action}",
        ...
        getContactList: '/contactlist?page={number}&limit={limit}&isDoNotContactList={isDoNotContactList}',
        ...
        getContactListMC: "/contact?page={number}&limit={limit}&status={status}",
        getContactListSe: "/contact?page={number}&limit={limit}&search={search}",
